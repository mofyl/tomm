...
type MMUserPlatformRoles struct {
	// @inject_tag: db:"id"
	Id int64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty" db:"id"`
	// @inject_tag: db:"mm_user_id"
	MmUserId string `protobuf:"bytes,2,opt,name=mm_user_id,json=mmUserId,proto3" json:"mm_user_id,omitempty" db:"mm_user_id"`
	// @inject_tag: db:"role_sign"
	RoleSign             string   `protobuf:"bytes,3,opt,name=role_sign,json=roleSign,proto3" json:"role_sign,omitempty" db:"role_sign"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *MMUserPlatformRoles) Reset()         { *m = MMUserPlatformRoles{} }
func (m *MMUserPlatformRoles) String() string { return proto.CompactTextString(m) }
func (*MMUserPlatformRoles) ProtoMessage()    {}
func (*MMUserPlatformRoles) Descriptor() ([]byte, []int) {
	return fileDescriptor_4c16552f9fdb66d8, []int{8}
}
func (m *MMUserPlatformRoles) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MMUserPlatformRoles) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MMUserPlatformRoles.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MMUserPlatformRoles) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MMUserPlatformRoles.Merge(m, src)
}
func (m *MMUserPlatformRoles) XXX_Size() int {
	return m.Size()
}
func (m *MMUserPlatformRoles) XXX_DiscardUnknown() {
	xxx_messageInfo_MMUserPlatformRoles.DiscardUnknown(m)
}

var xxx_messageInfo_MMUserPlatformRoles proto.InternalMessageInfo

func (m *MMUserPlatformRoles) GetId() int64 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *MMUserPlatformRoles) GetMmUserId() string {
	if m != nil {
		return m.MmUserId
	}
	return ""
...
func (m *MMUserPlatformRoles) GetRoleSign() string {
	if m != nil {
		return m.RoleSign
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*MMUserPlatformRoles)(nil), "model.MMUserPlatformRoles")
}
...
var fileDescriptor_4c16552f9fdb66d8 = []byte{
	...
	,
}
...
func (m *MMUserPlatformRoles) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MMUserPlatformRoles) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MMUserPlatformRoles) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MMUserPlatformRoles) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MMUserPlatformRoles) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MMUserPlatformRoles: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MMUserPlatformRoles: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
