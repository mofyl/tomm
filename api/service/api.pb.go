...
type PlatformInfo struct {
	...
	SignUrl string `protobuf:"bytes,7,opt,name=sign_url,json=signUrl,proto3" json:"sign_url,omitempty" db:"back_url"`
...
type CodeInfo struct {
	...
	// @inject_tag: db:"code"
	Code string `protobuf:"bytes,3,opt,name=code,proto3" json:"code,omitempty" db:"code"`
	// @inject_tag: db:"create_time"
	...
	MmUserId             string   `protobuf:"bytes,5,opt,name=mm_user_id,json=mmUserId,proto3" json:"mm_user_id,omitempty" db:"mm_user_id"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
